...
RSpec.describe 'the drinks index page', type: :feature do
  ...
  it 'displays the names of all drinks and their attributes' do
    ...
    expect(page).to have_content(@mango_smth.name)
    expect(page).to have_content(@mango_smth.calories)
    expect(page).to have_content(@mango_smth.has_milk)
    expect(page).to have_content(@mango_smth.created_at)
    expect(page).to have_content(@mango_smth.updated_at)
  end
end
